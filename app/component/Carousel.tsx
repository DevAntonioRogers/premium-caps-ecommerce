...
import mens from "@/public/gridimage1.jpeg";
import womans from "@/public/gridimage2.jpeg";
import Image from "next/image";

const Carousel = () => {
  return (
    <div className="relative grid md:grid-rows-2 md:grid-cols-4 grid-cols-2  grid-rows-none gap-2 md:max-h-[500px] h-full">
      ...
      <div className="md:row-start-1 md:col-start-4 md:row-end-3 md:col-end-5">
        <Image className="h-full w-full object-cover" src={mens} alt="test" width={0} height={0} />
      </div>

      <div className="hidden md:block md:row-start-1 md:col-start-1 md:row-end-3 md:col-end-2">
        <Image className="h-full w-full object-cover" src={womans} alt="test" width={0} height={0} />
      </div>
    </div>
  );
};
